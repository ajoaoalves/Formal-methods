...
# AB Testing is an optional sub-feature of Phone
...
# ABTesting requires BasicQA
s.add(Implies(ABTesting,BasicQA))
...
#RESPOSTA: No exists dead Features!
...
#RESPOSTA:
# Survey License QA AdvancedLicense BasicQA 
# Survey License Statistics QA AdvancedLicense BasicQA 
# Survey License Statistics QA AdvancedLicense MultimediaQA 
# Survey License QA AdvancedLicense MultimediaQA 
# Survey License QA BasicLicense BasicQA 
...
# Survey License QA AdvancedLicense BasicQA MultimediaQA 
# Survey License Statistics QA BasicLicense BasicQA 
# Survey License Statistics QA AdvancedLicense BasicQA MultimediaQA 
# There are 10 possible products!

#To the questions -If Basic QA required AB testing would there be dead features? NO